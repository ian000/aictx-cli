...
**aictx-cli** (AI Context CLI) 是专为 AI 辅助工程时代打造的 **Context as Code (CaC)** 基础设施。它通过独创的 **MOC (Map of Content) 精准路由机制**，将隐性的架构规约、业务红线转化为大模型（LLM/Agent）能够精准理解的显性上下文。

aictx 旨在解决一个绝对痛点：**如何在极低 Token 消耗的前提下，将 AI 幻觉率降至冰点？** 无论你是全栈独立开发者，还是几十人的中大型研发团队，aictx 都能彻底终结“大模型自由发挥导致架构崩塌”的梦魇。
