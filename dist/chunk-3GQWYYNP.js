import{intro as y,outro as j,spinner as S,select as C,text as E,multiselect as v,isCancel as I,cancel as b,confirm as D}from"@clack/prompts";import d from"picocolors";var H={intro:e=>y(d.bgCyan(d.black(" aictx "))+" "+d.bold(e)),outro:e=>j(d.green(e)),checkCancel:e=>(I(e)&&(b("\u64CD\u4F5C\u5DF2\u53D6\u6D88"),process.exit(0)),e),async askConfirm(e,t=!0){let r=await D({message:e,initialValue:t});return this.checkCancel(r)},async askText(e,t,r){let i=await E({message:e,placeholder:t,defaultValue:r});return this.checkCancel(i)},async askSelect(e,t){let r=await C({message:e,options:t});return this.checkCancel(r)},async askMultiSelect(e,t,r=!0,i){let o=await v({message:e,options:t,required:r,initialValues:i});return this.checkCancel(o)},createSpinner(){let e=S();return{start:t=>e.start(t),stop:t=>e.stop(t),message:t=>e.message(t)}}};import{execa as T}from"execa";async function Y(e,t){let r=process.argv[1];if(!r)throw new Error("\u65E0\u6CD5\u5B9A\u4F4D\u5F53\u524D aictx CLI \u5165\u53E3\uFF0C\u8BF7\u624B\u52A8\u6267\u884C\u5BF9\u5E94\u547D\u4EE4\u3002");await T(process.execPath,[r,...e],{cwd:t,stdio:"inherit"})}import n from"fs-extra";import s from"path";import{fileURLToPath as L}from"url";import c from"fs-extra";import u from"path";import{fileURLToPath as $}from"url";var p="<!-- aictx-codex-start -->",f="<!-- aictx-codex-end -->";function A(){let e=$(import.meta.url),t=u.dirname(e),r=t.endsWith("dist");return u.resolve(t,r?"templates":"../../templates")}function P(){return`${p}
